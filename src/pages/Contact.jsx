            ...
            <form className="mt-10 space-y-6">
              <div className="grid gap-6 md:grid-cols-2">
                <input
                  ...
                  className="h-14 rounded-xl border border-black/10 bg-white px-5 outline-none focus:border-black"
                />
                ...
                <select className="h-14 rounded-xl border border-black/10 bg-white px-5 outline-none focus:border-black">
              ...
              <textarea
                ...
                className="w-full rounded-xl border border-black/10 bg-white p-5 outline-none focus:border-black"
              />
