...
const Footer = () => {
  return (
    <div className="">
    <footer className="w-full hidden sm:block overflow-hidden bg-black text-white px-4 sm:px-20 py-20">
    ...
    <footer className="w-full sm:hidden overflow-x-hidden bg-black text-white px-4 sm:px-20 py-20">
  {/* Logo */}
  <div className="mb-10">
