            ...
            >
              ...
              <div className="p-3 lg:p-5 flex flex-col flex-1">
                ...
                <a
                  ...
                  className="mt-4 lg:mt-6 w-full inline-flex items-center justify-center gap-1.5 lg:gap-2 rounded-xl bg-black px-2 lg:px-4 py-2 lg:py-3 text-[10px] lg:text-sm text-white hover:bg-black transition"
                >
